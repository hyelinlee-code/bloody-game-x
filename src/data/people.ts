...
export const people: Person[] = [
  /* ───────────────────────── 시즌1 팀 ───────────────────────── */
  {
    ...
    otherShows: [
      { show: 'The Genius: Rules of the Game', showKo: '더 지니어스: 게임의 법칙 (시즌1)', year: '2013', result: '3위', resultEn: '3rd', rank: 3, fieldSize: 13, scope: ['genius-1'] },
      { show: 'The Genius: Rule Breaker', showKo: '더 지니어스: 룰 브레이커 (시즌2)', year: '2014', result: '우승', resultEn: 'Winner', rank: 1, scope: ['genius-2'] },
      { show: 'The Genius: Grand Final', showKo: '더 지니어스: 그랜드 파이널 (시즌4)', year: '2015', result: '3화 데스매치 탈락', resultEn: 'Out in the round-three death match', scope: ['genius-4'] },
      { show: 'Knowing Bros', showKo: '아는 형님', year: '2016–', result: '고정 출연', resultEn: 'Series regular', scope: [] },
    ],
    ...
    priorElsewhere: [
      {
        ...
        scope: ['genius-1', 'genius-2', 'genius-4'],
        scopes: { show: [], showKo: [], result: ['genius-2'], resultEn: ['genius-2'] },
        arcParts: [
          { text: "시즌1 「게임의 법칙」(2013)에서는 11화 데스매치에서 김경란에게 패해 3위로 끝났다. ", scope: ['genius-1'] },
          { text: "이듬해 시즌2 「룰 브레이커」에서는 가넷 62개를 모아 결승에서 프로게이머 출신 임요환을 꺾고 우승했고, 이 시즌으로 그는 예능인이 아니라 플레이어로 다시 분류됐다. ", scope: ['genius-2'] },
          { text: "2015년 올스타전 「그랜드 파이널」에는 시즌2 우승자 자격으로 복귀했지만, 자신을 정신적 지주라 부르며 따라다니던 김경훈에게 3화 데스매치 베팅 가위바위보로 패해 일찍 짐을 쌌다. ", scope: ['genius-2', 'genius-4'] },
          { text: "네 시즌 중 세 시즌에 나와 우승 한 번, 3위 한 번, 그리고 자기 편에게 당한 탈락 한 번을 남겼다.", scope: ['genius-1', 'genius-2', 'genius-4'] },
        ],
        arcEnParts: [
          { text: "In season 1, Rules of the Game (게임의 법칙, 2013), he lost the episode-eleven Death Match to the broadcaster Kim Kyung-ran and finished third. ", scope: ['genius-1'] },
          { text: "The following year he took season 2, Rule Breaker (룰 브레이커), on 62 garnets, beating the former StarCraft professional Lim Yo-hwan in the final — the season that reclassified him from variety regular to player. ", scope: ['genius-2'] },
          { text: "He came back for the 2015 all-star season, Grand Final, as season 2's champion, and went out early: Kim Kyung-hoon, who had spent the season calling him his anchor, beat him in the episode-three Death Match at betting rock-paper-scissors. ", scope: ['genius-2', 'genius-4'] },
          { text: "Three of the show's four seasons, one win, one third place, and one elimination at the hands of his own ally.", scope: ['genius-1', 'genius-2', 'genius-4'] },
        ],
      },
    ],
    x: {
    ...
    bioParts: [
      { text: "1990년대 그룹 룰라의 리더이자 프로듀서로 출발해 지금은 예능 고정 출연자로 자리 잡은 방송인이다. ", scope: [] },
      { text: "JTBC 「아는 형님」에 오래 몸담았고, 두뇌 서바이벌 장르에서는 「더 지니어스」 시즌2 우승자로 기억된다. ", scope: ['genius-2'] },
      { text: "피의 게임 시즌1에서는 플레이어가 아니라 스튜디오 패널석에 앉아 참가자들을 지켜보던 쪽이었다.", scope: [] },
    ],
  },
  {
    id: 'park-ji-min',
    ...
    otherShows: [
      { show: 'Welcome, First Time in Korea?', showKo: '어서와~ 한국은 처음이지?', result: '진행', resultEn: 'Host', scope: [] },
      { show: 'Oh Eun-young Report: Marriage Hell', showKo: '오은영 리포트 – 결혼지옥', result: '진행', resultEn: 'Host', scope: [] },
      { show: 'MBC News Today', showKo: 'MBC 뉴스투데이', result: '진행', resultEn: 'Anchor', scope: [] },
    ],
    ...
    priorElsewhere: [
      {
        ...
        scope: ['bg3'],
        scopes: { show: [], showKo: [], result: [], resultEn: [] },
        arcParts: [
          { text: "프랜차이즈 안에서의 이력이 길어서 가려지는 사실이 하나 있다 — 본업은 방송 진행이고, 피의 게임은 그 본업의 일부다. MBC 아나운서로 「뉴스투데이」 앵커석에 앉았고, 「어서와~ 한국은 처음이지?」와 「오은영 리포트 – 결혼지옥」을 진행했다. ", scope: [] },
          { text: "뉴스 데스크와 예능 진행석을 함께 쓰는 이력이 시즌1·2를 참가자로 뛰고 시즌3을 진행자로 맞은 유일한 사람이 나올 수 있었던 조건이다: 판 안으로 들어갈 수도, 판을 굴릴 수도 있는 자격증을 처음부터 갖고 있었다.", scope: ['bg3'] },
        ],
        arcEnParts: [
          { text: "One fact gets buried under how long her franchise record is: presenting is the day job, and Bloody Game is part of it. As an MBC announcer she has anchored MBC News Today (뉴스투데이) and hosted Welcome, First Time in Korea? (어서와~ 한국은 처음이지?) and Oh Eun-young Report: Marriage Hell (오은영 리포트 – 결혼지옥). ", scope: [] },
          { text: "A record that covers both a news desk and a variety host's chair is the condition that produced the only person to play seasons 1 and 2 and then preside over season 3: she already held both qualifications — to be inside the board, and to run it.", scope: ['bg3'] },
        ],
      },
    ],
    x: {
    ...
    bioParts: [
      { text: "MBC 아나운서로 뉴스와 예능을 오가며 활동해 왔다. 「어서와 한국은 처음이지?」와 「오은영 리포트 – 결혼지옥」 등을 진행했다. ", scope: [] },
      { text: "피의 게임 프랜차이즈에 가장 깊이 관여한 인물로, 시즌1과 시즌2에서는 참가자로 뛰었고, 시즌3에서는 경쟁하는 쪽이 아니라 잔해 유령 카지노의 딜러 겸 연옥 담당 집사로 나왔다 — 진행자가 아니라 보조 출연이고, 제작진이 출연 사실 자체를 반전으로 아끼둔 탓에 6화에야 처음 등장했다.", scope: ['bg3'] },
    ],
  },
  {
    id: 'jung-keun-woo',
    ...
    otherShows: [
      { show: 'Baseball Representatives: League of Nerds', showKo: '야구대표자: 덕후들의 리그', year: '2024', result: 'SSG 대표 대타 게스트 (5화)', resultEn: 'Stand-in for the SSG seat, episode 5', scope: [] },
      { show: 'The Strongest Baseball', showKo: '최강야구 (JTBC)', year: '2022–', result: '최강 몬스터즈 창단 멤버', resultEn: 'Founding member of the Monsters', scope: [] },
      { show: 'Fireball Baseball', showKo: '불꽃야구', year: '2025–', result: '고정 출연', resultEn: 'Series regular', scope: [] },
      { show: 'Ping-Pong Nation', showKo: '올 탁구나!', year: '2022–', result: '전설의 강호팀 고정', resultEn: 'Regular, the veterans’ side', scope: [] },
      { show: 'Youth Baseball Team: Not Out Yet', showKo: '청춘야구단: 아직은 낫아웃 (KBS)', year: '2022', result: '수석코치', resultEn: 'Head coach', scope: [] },
    ],
  ...
  },
  {
    ...
    otherShows: [
      { show: 'Project Genius', showKo: '프로젝트 지니어스 (투에이스)', year: '2022', result: '촬영 후 미공개', resultEn: 'Shot, never released', scope: [] },
    ],
    ...
    priorElsewhere: [
      {
        ...
        scopes: { show: [], showKo: [], result: [], resultEn: [] },
        arcParts: [
          { text: "방송 밖에서 이 사람에 대해 확인되는 것은 직업 하나가 아니라 직업의 순서다. 경찰대학을 졸업해 경찰관이 됐고, 그다음에 로스쿨을 거쳐 변호사시험에 합격했다 — 시험을 통과해 들어간 자리에서 다시 시험을 봐서 다음 자리로 옮긴 이력이고, 이 스무 명 중 누구와도 겹치지 않는 경로다. ", scope: [] },
          { text: "프랜차이즈의 초대 챔피언인데 바깥 이력이 짧은 것은 자료가 없어서가 아니다. 그는 방송을 직업으로 삼지 않았고, 시즌1 이후 이름이 오른 촬영은 2022년 투에이스의 '프로젝트 지니어스' 한 건뿐이며 그마저 공개되지 않았다. 판을 이기고 돌아간 곳이 스튜디오가 아니라 원래 직장인 사람이다.", scope: ['bg1'] },
        ],
        arcEnParts: [
          { text: "What the record outside television gives on this man is not one job but the order of them. He graduated from the National Police University and became a serving officer; then he went through law school and passed the bar. It is a route made of examinations — a seat won by one exam, left for another exam, and a second seat taken with it — and nobody else in this twenty has walked it. ", scope: [] },
          { text: "The reason the franchise's first champion has so little history outside his own season is not that the material is missing. He did not take television as a job: the only other shoot his name is attached to since season 1 is TwoAces' Project Genius (프로젝트 지니어스) in 2022, and that was never released. He won the house and went back to work.", scope: ['bg1'] },
        ],
      },
    ],
    x: {
    ...
    bioParts: [
      { text: "경찰대학을 졸업한 현직 경찰관으로, 이후 로스쿨을 거쳐 변호사 자격까지 취득했다. ", scope: [] },
      { text: "피의 게임 시즌1의 최종 우승자이며, 프랜차이즈 첫 번째 챔피언이라는 자리를 갖고 있다.", scope: ['bg1'] },
    ],
  },
  ...
  /* ───────────────────────── 시즌2 팀 ───────────────────────── */
  {
    ...
    otherShows: [
      { show: 'Baseball Representatives: League of Nerds', showKo: '야구대표자: 덕후들의 리그', year: '2024–25', result: 'kt wiz 대표 고정', resultEn: 'Regular, the kt wiz seat', scope: [] },
      { show: 'Knowing Bros', showKo: '아는 형님', year: '2025', result: '464회 게스트', resultEn: 'Guest, episode 464', scope: [] },
      { show: 'Kim Soo-mi’s Side Dishes', showKo: '수미네 반찬', year: '2020', result: '고정 출연', resultEn: 'Series regular', scope: [] },
      { show: 'Ha Seung-jin Talk', showKo: '하승진톡 (유튜브)', year: '2020–', result: '진행', resultEn: 'Host', scope: [] },
    ],
  ...
  },
  {
    ...
    otherShows: [
      { show: 'War of the Poker Gods', showKo: '포커 신들의 전쟁 (시즌2·3)', year: '2021–23', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'Project Genius', showKo: '프로젝트 지니어스 (투에이스)', year: '2022', result: '촬영 후 미공개', resultEn: 'Shot, never released', scope: [] },
    ],
    ...
    priorElsewhere: [
      {
        ...
        scopes: { show: [], showKo: [], result: [], resultEn: [] },
        arcParts: [
          { text: "고등학교 축제 부스에서 포커를 처음 만났고, 2019년에 크게 무너진 적이 있다. 2020년 WSOP 온라인 GG포커 이벤트 #46을 우승해 한국인으로는 세 번째로 골드 브레이슬릿을 가져갔고, 이듬해 WPT 딥스택 이벤트 #18과 윈 스프링 클래식 NLH 챔피언십을, 2022년에는 WPT 벨라지오 이벤트 #5와 PGT 하이롤러 시리즈 이벤트 #36을 연달아 우승했다. ", scope: [] },
          { text: "방송으로 넘어온 것은 유튜브 채널 투에이스의 홀덤 서바이벌 '포커 신들의 전쟁'이다 — 2021년 8월 16일부터 9월 30일까지 열린 시즌2 인비테이셔널에 16인 중 한 명으로 출전했고(이 대회는 홍진호가 우승했다), 시즌3에도 참가자로 나왔다. ", scope: ['poker-gods'] },
          { text: "본인 채널 '아르테포커'에서는 1:1 홀덤 챌린지를 굴리며 임요환·김수조·서출구를 상대로 앉혔다. 2025년 11월부터는 CHEEZEE 팀 프로다.", scope: [] },
        ],
        arcEnParts: [
          { text: "He met poker at a booth at a high-school festival, and came apart financially in 2019. In 2020 he won WSOP Online GGPoker Event #46 to become the third Korean ever to take a gold bracelet; the following year he took WPT DeepStacks Event #18 and the Wynn Spring Classic NLH Championship, and in 2022 WPT Bellagio Event #5 and PGT High Roller Series Event #36. ", scope: [] },
          { text: "Television came through War of the Poker Gods (포커 신들의 전쟁), the hold'em survival series run by the YouTube channel TwoAces (투에이스): he was one of sixteen in the season 2 invitational, 16 August to 30 September 2021 — the tournament Hong Jin-ho won — and came back as a player for season 3. ", scope: ['poker-gods'] },
          { text: "On his own channel, Arte Poker (아르테포커), he runs a one-on-one hold'em challenge and has sat the StarCraft professional Lim Yo-hwan, the poker player Kim Su-jo and XITSUH down opposite him. He has been a CHEEZEE team pro since November 2025.", scope: [] },
        ],
      },
    ],
    x: {
  ...
  },
  {
    ...
    bioParts: [
      { text: "하이라이트 레코즈 소속 래퍼로 뉴욕대학교 철학과를 졸업했다. 태권도 주니어 올림픽 금메달 이력도 있다. ", scope: [] },
      { text: "「쇼미더머니」 6·777·8에 출연했고, 카카오TV 웹예능 「생존남녀」에서 우승하며 서바이벌 예능에도 이름을 올렸다.", scope: ['survival-men-women'] },
    ],
  },
  {
    id: 'lee-jin-hyung',
    ...
    otherShows: [
      { show: 'Problematic Men', showKo: '뇌섹시대 – 문제적 남자', year: '2020', result: '게스트', resultEn: 'Guest', scope: [] },
    ],
    ...
    priorElsewhere: [
      {
        ...
        scopes: { show: [], showKo: [], result: [], resultEn: [] },
        arcParts: [
          { text: "이 사람의 이력에서 눈에 띄는 것은 만점이 아니라 만점을 받은 시점이다. 서울과학고를 졸업하고 2014년 서울대 자유전공학부에 입학했지만 중퇴했고, 이미 서울대생이었던 사람이 몇 해 뒤 수능을 다시 치러 2019학년도 만점자가 됐다. 그리고 그 점수로 고른 곳이 같은 학교의 의과대학이었다 — 19학번으로 들어가 졸업했고, 지금은 청담동에서 피부과 진료를 본다. ", scope: [] },
          { text: "만점자 자격으로 2020년 tvN 「문제적 남자」에 게스트로 나온 것이 방송의 시작이었고, 3년 뒤 피의 게임 시즌2에는 의대생 신분으로 들어가 우승했다. 한 번 들어간 학교를 나와서 다시 시험을 보고 같은 학교로 돌아가는 사람과, 아름다운 패배보다 추악한 승리를 택했다고 말하는 사람은 같은 사람이다.", scope: ['bg2'] },
        ],
        arcEnParts: [
          { text: "The striking thing in this record is not the perfect score but when it was taken. He finished Seoul Science High School, entered Seoul National University's Liberal Studies programme with the 2014 intake, and left it — and then a man who was already an SNU student sat the national exam again and posted a perfect score for 2019. What he spent it on was the medical school of the same university: he entered with the 2019 intake, graduated, and now practises dermatology in Cheongdam. ", scope: [] },
          { text: "Television started with the score, as a guest on tvN's Problematic Men (문제적 남자) in 2020; three years later he walked into Bloody Game 2 as a medical student and won it. The man who left one seat, re-sat the exam and took another at the same university is the same man who said he had chosen an ugly victory over a beautiful defeat.", scope: ['bg2'] },
        ],
      },
    ],
    x: {
    ...
    bioParts: [
      { text: "서울과학고를 나와 서울대 자유전공학부에 14학번으로 입학했다가 중퇴했고, 2019학년도 수능 만점자로 서울대 의과대학에 19학번으로 다시 들어가 졸업했다. 지금은 청담동의 피부과에서 진료를 본다. ", scope: [] },
      { text: "피의 게임 시즌2에 의대생 신분으로 참가해 최종 우승했다.", scope: ['bg2'] },
    ],
  },
  ...
  /* ───────────────────────── 시즌3 팀 ───────────────────────── */
  {
    ...
    otherShows: [
      { show: 'The Genius: Rules of the Game', showKo: '더 지니어스: 게임의 법칙 (시즌1)', year: '2013', result: '우승', resultEn: 'Winner', rank: 1, fieldSize: 13, scope: ['genius-1'] },
      { show: 'The Genius: Rule Breaker', showKo: '더 지니어스: 룰 브레이커 (시즌2)', year: '2014', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'The Genius: Grand Final', showKo: '더 지니어스: 그랜드 파이널 (시즌4)', year: '2015', result: '4위', resultEn: '4th', rank: 4, fieldSize: 13, scope: ['genius-4'] },
      { show: 'The Time Hotel', showKo: '더 타임호텔', year: '2023', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'War of the Poker Gods', showKo: '포커 신들의 전쟁 (시즌2·3)', year: '2021–23', result: '시즌2 인비테이셔널 우승 · 시즌3 팀 마스터', resultEn: 'Won the season 2 invitational; team master in season 3', scope: ['poker-gods'] },
      { show: 'Project Genius', showKo: '프로젝트 지니어스 (투에이스)', year: '2022', result: '촬영 후 미공개', resultEn: 'Shot, never released', scope: [] },
    ],
    ...
    priorElsewhere: [
      {
        ...
        scope: ['genius-1', 'genius-2', 'genius-4'],
        scopes: { show: [], showKo: [], result: ['genius-1'], resultEn: ['genius-1'] },
        arcParts: [
          { text: "13인 참가자 중 한 명으로 들어와 시리즈의 초대 우승자가 됐다. 가넷 79개를 모아 상금 7,900만 원을 가져갔고, 이 한 시즌으로 스타크래프트 은퇴 뒤의 그를 두뇌 게임 플레이어로 다시 세웠다 — 이후 한국 서바이벌 예능이 계속 그를 부르는 이유가 여기서 만들어졌다. ", scope: ['genius-1'] },
          { text: "이듬해 시즌2 「룰 브레이커」에서는 중반에 탈락했고, 2015년 올스타전 「그랜드 파이널」에는 시즌1 우승자 자격으로 복귀했지만 10화 데스매치 양면포커에서 김경훈에게 지며 4위로 마쳤다.", scope: ['genius-1', 'genius-2', 'genius-4'] },
        ],
        arcEnParts: [
          { text: "He came in as one of thirteen players and left as the series' inaugural champion, banking 79 garnets and a prize of 79 million won. That single season re-cast him — the retired StarCraft professional became a brain-game player, which is the reason Korean survival television has kept calling ever since. ", scope: ['genius-1'] },
          { text: "He went out mid-season in season 2, Rule Breaker (룰 브레이커), the following year, and returned for the 2015 all-star season, Grand Final, as season 1's champion, where he lost the episode-ten Death Match at double-sided poker to Kim Kyung-hoon and finished fourth.", scope: ['genius-1', 'genius-2', 'genius-4'] },
        ],
      },
    ],
    x: {
    ...
    bioParts: [
      { text: "'폭풍저그'로 불린 전설적인 스타크래프트 프로게이머 출신이다. ", scope: [] },
      { text: "은퇴 후 포커로 전향해 2022년 WSOP 브레이슬릿을 획득했고, 「더 지니어스」 초대 우승자로 한국 두뇌 서바이벌 장르의 상징적 인물이 됐다. ", scope: ['genius-1'] },
      { text: "피의 게임에는 시즌2와 시즌3에 연달아 출연했다.", scope: [] },
    ],
  },
  {
    id: 'seo-chul-gu',
    ...
    otherShows: [
      ...
      { show: 'Death Game: Bet Ten Million', showKo: '데스게임: 천만원을 걸어라 (넷플릭스)', year: '2026', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'Death Game 2: The Last Winner', showKo: '데스게임2: 최후의 승자 (넷플릭스)', year: '2026', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'Arte Poker 1:1 hold’em challenge', showKo: '아르테포커 1:1 홀덤 챌린지', result: '도전자', resultEn: 'Challenger', scope: [] },
    ],
  ...
  },
  {
    ...
    otherShows: [{ show: 'Single’s Inferno 3', showKo: '솔로지옥3', year: '2023–24', result: '출연', resultEn: 'Cast member', scope: [] }],
  ...
  },
  {
    ...
    otherShows: [
      { show: 'University War', showKo: '대학전쟁 (쿠팡플레이)', year: '2023', result: '카이스트팀 리더', resultEn: 'KAIST team leader', scope: [] },
      { show: 'The Influencer', showKo: '더 인플루언서 (넷플릭스)', year: '2024', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'Death Game: Bet Ten Million', showKo: '데스게임: 천만원을 걸어라 (넷플릭스)', year: '2026', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'Death Game 2: The Last Winner', showKo: '데스게임2: 최후의 승자 (넷플릭스)', year: '2026', result: '참가', resultEn: 'Contestant', scope: [] },
    ],
  ...
  /* ───────────────────────── 챌린저 팀 ───────────────────────── */
  {
    ...
    otherShows: [
      { show: 'The Genius: Black Garnet', showKo: '더 지니어스: 블랙가넷 (시즌3)', year: '2014', result: '12위', resultEn: '12th', rank: 12, scope: ['genius-3'] },
      { show: 'The Genius: Grand Final', showKo: '더 지니어스: 그랜드 파이널 (시즌4)', year: '2015', result: '준우승', resultEn: 'Runner-up', rank: 2, fieldSize: 13, scope: ['genius-4'] },
      { show: 'Society Game spinoffs / 금수저 전쟁', showKo: '금수저 전쟁', year: '2024', result: '공동 3위', resultEn: 'Joint 3rd', scope: ['golden-spoon-war'] },
    ],
    ...
    priorElsewhere: [
      {
        ...
        scope: ['genius-1', 'genius-3', 'genius-4'],
        scopes: { show: [], showKo: [], result: ['genius-4'], resultEn: ['genius-4'] },
        arcParts: [
          { text: "지원자 3,114명이 몰린 일반인 선발전을 뚫고 시즌3 「블랙가넷」에 들어왔지만, 1화 메인매치 과일가게에서 배신으로 가넷 2개를 챙기며 단독 우승한 것이 곧바로 표적이 됐고 2화 데스매치 베팅 가위바위보에서 강용석에게 패해 12위로 끝났다. ", scope: ['genius-3'] },
          { text: "이듬해 올스타전 「그랜드 파이널」은 완전히 다른 시즌이었다. 가넷 0개에서 시작해 초반 세 회차 동안 일부러 어긋난 수를 두며 짜인 연합들을 무너뜨렸고, 3화 데스매치에서는 자신이 정신적 지주라 부르던 이상민을 베팅 가위바위보 22대 0으로 완파했다. ", scope: ['genius-4'] },
          { text: "6화에서는 이준석의 편인 척하며 반대편을 도와 5인 공동 우승을 만들었고, 7화 데스매치에서 최정문을 같은 그림 찾기로 꺾었으며, 10화 데스매치 양면포커에서는 시즌1 우승자 홍진호를 이겨 탈락시켰고, 11화 하우머치에서는 권혁수의 지출 패턴을 계산해 단독 우승했다. ", scope: ['genius-1', 'genius-4'] },
          { text: "결승 숫자장기에서 장동민에게 지며 준우승으로 마감했다. 데스매치 세 번을 모두 이겼고 그중 둘은 그 시즌 최고 인지도의 두 사람이었다.", scope: ['genius-4'] },
        ],
        arcEnParts: [
          { text: "He came through an open selection that drew 3,114 applicants to reach season 3, Black Garnet (블랙가넷), and it ended fast: a solo win in the episode-one main match, the fruit shop, taken by betrayal for two garnets, marked him immediately, and he lost the episode-two Death Match at betting rock-paper-scissors to the lawyer Kang Yong-seok, finishing twelfth. ", scope: ['genius-3'] },
          { text: "The following year's all-star season, Grand Final, was a different animal. Starting from zero garnets, he spent the first three episodes playing deliberately wrong moves that collapsed the coordinated alliances around him, and in the episode-three Death Match he took apart Lee Sang-min — the man he had been calling his anchor — 22 to nil at betting rock-paper-scissors. ", scope: ['genius-4'] },
          { text: "In episode six he passed as an ally of the politician Lee Jun-seok while quietly working for the other side, engineering a five-way joint win; in episode seven he beat Choi Jung-moon at matching pairs; in the episode-ten Death Match, at Two-Sided Poker, he put out Hong Jin-ho, the champion of season 1; and in episode eleven he read the comedian Kwon Hyuk-soo's spending pattern and won How Much outright. ", scope: ['genius-1', 'genius-4'] },
          { text: "He lost the final to Jang Dong-min at number chess and finished runner-up. He won all three of his Death Matches, and two of them were against the best-known players in the season.", scope: ['genius-4'] },
        ],
      },
    ],
    x: {
    ...
    bioParts: [
      { text: "일리노이대 어바나-샴페인에서 재료공학을 전공하고 서울대 대학원에서 화학생물공학을 수학한 뒤 창업했다. 2023년 무카페인 대체커피 브랜드를 론칭했다. ", scope: [] },
      { text: "두뇌 서바이벌 팬층에는 tvN 「더 지니어스: 그랜드 파이널」 준우승자로 잘 알려져 있다.", scope: ['genius-4'] },
    ],
  },
  {
    id: 'kim-yoo-hyun',
    ...
    otherShows: [
      { show: 'The Genius: Black Garnet', showKo: '더 지니어스: 블랙가넷 (시즌3)', year: '2014', result: '5위', resultEn: '5th', rank: 5, scope: ['genius-3'] },
      { show: 'The Genius: Grand Final', showKo: '더 지니어스: 그랜드 파이널 (시즌4)', year: '2015', result: '9위', resultEn: '9th', rank: 9, fieldSize: 13, scope: ['genius-4'] },
      { show: 'Project Genius', showKo: '프로젝트 지니어스 (투에이스)', year: '2022', result: '촬영 후 미공개', resultEn: 'Shot, never released', scope: [] },
    ],
  ...
  },
  {
    ...
    otherShows: [
      { show: 'The Time Hotel', showKo: '더 타임호텔', result: '참가', resultEn: 'Contestant', scope: [] },
      { show: 'Problematic Men', showKo: '뇌섹시대 – 문제적 남자', year: '2016', result: '출연', resultEn: 'Guest', scope: [] },
      ...
      { show: 'Miss Korea', showKo: '미스코리아', year: '2014', result: '서울 선(善)·친선상', resultEn: 'Miss Seoul, Seon (2nd) and the congeniality award', scope: [] },
    ],
  ...
  },
  {
    ...
    otherShows: [{ show: 'University War 3', showKo: '대학전쟁3 (쿠팡플레이)', year: '2025–26', result: '카이스트팀 3위', resultEn: 'KAIST team, 3rd', scope: ['university-war-3'] }],
    ...
    bioParts: [
      { text: "경기북과학고를 조기졸업하고 KAIST 수리과학과에 22학번으로 입학한 학생으로, 쿠팡플레이 두뇌 서바이벌 「대학전쟁3」에 카이스트 팀으로 출전해 3위를 기록했다. ", scope: ['university-war-3'] },
      { text: "이번 라인업에서 유일한 현역 학생 참가자이자 가장 어린 참가자다.", scope: [] },
    ],
  },
  ...
  /* ───────────────────────── 루키 팀 ───────────────────────── */
  {
    ...
    otherShows: [
      { show: 'Gag Concert', showKo: '개그콘서트', year: '2012–2020', result: '고정 출연', resultEn: 'Series regular', scope: [] },
      ...
      { show: 'Knowing Bros', showKo: '아는 형님', year: '2025–26', result: '469회 해설위원 · 513회 게스트', resultEn: 'Commentator on ep. 469, guest on ep. 513', scope: [] },
      { show: 'King of Mask Singer', showKo: '복면가왕', year: '2021, 2025', result: '출연', resultEn: 'Contestant', scope: [] },
      { show: 'Comedy Royale', showKo: '코미디 로얄 (넷플릭스)', year: '2023', result: '참가', resultEn: 'Contestant', scope: [] },
    ],
  ...
  },
  {
    ...
    otherShows: [
      { show: 'Single’s Inferno 3', showKo: '솔로지옥3', year: '2023–24', result: '출연', resultEn: 'Cast member', scope: [] },
      /* Where he said on the record that nothing came of the final couple —
         the sentence the 최혜선 edge is built on. */
      { show: 'Eat Breakfast Before You Go 2', showKo: '아침먹고 가2', year: '2024', result: '게스트', resultEn: 'Guest', scope: [] },
    ],
  ...
  },
  {
    ...
    otherShows: [
      { show: 'Miss Hammurabi', showKo: '미스 함무라비 (JTBC)', year: '2018', result: '출연', resultEn: 'Cast member', scope: [] },
      { show: 'Miss Korea', showKo: '미스코리아', year: '2013', result: '출전 (만 19세)', resultEn: 'Competed, at nineteen', scope: [] },
    ],
