...
export const people: Person[] = [
  ...
  },
  {
    ...
    x: {
      ...
      teamLabelKo: '시즌1 팀',
      teamLabelEn: 'Season 1 team',
      billing: '참가자였다가 진행자였다가, 다시 참가자석으로.',
      billingEn: "Player, then host, and now back in a player’s seat.",
    },
    confidence: 'high',
