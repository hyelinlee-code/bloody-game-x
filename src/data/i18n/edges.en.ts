...
export const edgesEn: Record<string, EdgeEn> = {
  'hong-jin-ho--seo-chul-gu--alliance-s2-0': {
    ...
    scope: ['bg2', 'bg3'],
    descriptionParts: [
      { text: "In Bloody Game 2 (2023) the wild team of hidden players that Hong Jin-ho belonged to abducted XITSUH out of the mansion on day three and recruited him, and from that point the two ran as the season's core pair. XITSUH called himself Hong Jin-ho's calculator, and played the part — a partner who deferred to Hong's reading of the board. ", scope: ['bg2'] },
      { text: "They lined up together again in Bloody Game 3 (2024–25), XITSUH joining the alliance built around Hong. ", scope: ['bg3'] },
      { text: "The connection outlived the broadcast: XITSUH took up poker after season 2 because of Hong, and says Hong went through his play with him point by point, from first to last.", scope: [] },
    ],
  },
  ...
  'hong-jin-ho--hyun-seong-joo--prior-show-1': {
    ...
    descriptionParts: [
      { text: "Their overlap at the poker table runs back years. ", scope: [] },
      { text: "Both were among the sixteen players in the season 2 invitational of War of the Poker Gods (포커 신들의 전쟁), the Texas hold'em survival series run by the YouTube channel TwoAces (투에이스), from 16 August to 30 September 2021 — Hyun Seong-joo competing as Komong (코몽) — and Hong Jin-ho won it. ", scope: ['poker-gods'] },
      { text: "They were back for season 3 (2022–23), Hong as a team master and Hyun as a player. Both hold WSOP bracelets. ", scope: [] },
      { text: "On the strength of all that, the show sold their meeting in Bloody Game 2 as a duel between two poker professionals; inside the season they simply sat on opposite sides, with no personal antagonism on record.", scope: ['bg2'] },
    ],
  },
  ...
  'lee-sang-min--hong-jin-ho--rivalry-6': {
    ...
    descriptionParts: [
      /* Not `[]`. The shared seasons are participation, but "the defining
         rivalry of the series" is the verdict `Edge.type` carries, and that
         type is sealed to the two seasons that produced it. Leaving this
         sentence always-visible would state the rivalry in prose while the
         type that means the same thing is hidden. Matches the Korean part. */
      { text: "Three shared seasons of tvN's The Genius, and the defining rivalry of the series. ", scope: ['genius-1', 'genius-2'] },
      { text: "They were both among the thirteen players in season 1, Rules of the Game (게임의 법칙, 2013), which Hong Jin-ho won with 79 garnets and a prize of 79 million won, while Lee Sang-min lost the episode-eleven Death Match to the broadcaster Kim Kyung-ran and finished third. ", scope: ['genius-1'] },
      { text: "The next year it inverted: Lee took season 2, Rule Breaker (룰 브레이커, 2013–14), on 62 garnets, beating the StarCraft professional Lim Yo-hwan in the final, and Hong went out mid-season. ", scope: ['genius-2'] },
      { text: "In 2015 both returned for the all-star season 4, Grand Final, one as the champion of season 1 and the other as the champion of season 2.", scope: ['genius-1', 'genius-2'] },
    ],
  },
  ...
  'hong-jin-ho--kim-kyung-hoon--prior-show-10': {
    ...
    descriptionParts: [
      { text: "Both were among the thirteen players of The Genius season 4, Grand Final (tvN, 2015) — Hong Jin-ho as the champion of season 1, Kim Kyung-hoon as season 3's representative. ", scope: ['genius-1'] },
      { text: "In episode ten they both lost the main match, 'Co-op Hold'em' (협동홀덤), and met one on one in the Death Match, 'Two-Sided Poker' (양면포커). Kim won it and put Hong out. Going in, Kim made no secret of having been a genuine fan through seasons 1 and 2, or of what it meant to be playing Two-Sided Poker himself.", scope: ['genius-4'] },
    ],
  },
  ...
  'hong-jin-ho--kim-yoo-hyun--prior-show-11': {
    ...
    scopes: { description: ['genius-1', 'genius-4'] },
    descriptionParts: [
      { text: "They were both part of the thirteen-strong all-star cast of The Genius: Grand Final (tvN, 2015), Hong Jin-ho as the champion of season 1 and Kim Yoo-hyun as an alumnus of season 3, Black Garnet (블랙가넷). ", scope: ['genius-1'] },
      { text: "It went beyond sharing a call sheet: in the episode-two main match, 'Horror Racing' (공포 레이싱), Kim worked as Hong's strategist and the two ran that episode together, and his style of play drew comparisons with Hong's own from the early and middle stretch of season 1. ", scope: ['genius-4'] },
      { text: "Both are professional poker players — Hong won a WSOP bracelet in 2022, and Kim was already being introduced as a professional gambler when he appeared in 2015.", scope: [] },
    ],
  },
  ...
  'seo-chul-gu--heo-seong-beom--rivalry-s3-17': {
    ...
    scope: ['bg3'],
    descriptionParts: [
      { text: "They spent Bloody Game 3 (November 2024 – January 2025, Wavve) on opposite ground from day one — XITSUH started in the mansion of blood, Heo Seong-beom in the paradise of blood — and the production had already sorted them apart, billing XITSUH as an all-star and Heo as a new star. As the blocs formed later in the season XITSUH was the brain of the side around Hong Jin-ho and Heo went with the Jang Dong-min alliance. The one head-on clash between them came in day ten's 'Good and Evil': Heo said in interview that he had tried to explain his thinking and had simply been ignored. It was that game and no more — there is no season-long feud on record. ", scope: ['bg3'] },
      { text: "Both then turned up as contestants on Netflix's Death Game: Bet Ten Million Won (데스게임: 천만원을 걸어라, 28 January – 1 April 2026) and its sequel Death Game 2: The Last Winner (데스게임2: 최후의 승자, 22 April – 17 June 2026), which makes three programmes running at the same table.", scope: [] },
    ],
  },
  ...
  'hyun-seong-joo--seo-chul-gu--mentor-25': {
    ...
    descriptionParts: [
      { text: "They met as fellow players on Bloody Game 2 (2023). ", scope: [] },
      { text: "Inside the season both started on the mansion team before XITSUH crossed to the wild team, which left them on opposite sides. ", scope: ['bg2'] },
      { text: "Once it was over, XITSUH took up hold'em under the influence of Hong Jin-ho and of Hyun Seong-joo, the professional who plays as Komong (코몽), and says he asked both of them for feedback — Hyun's advice mostly encouragement, Hong's finely itemised. XITSUH later turned up as an opponent on the one-on-one hold'em challenge series on Hyun's poker YouTube channel Arte Poker (아르테포커) — one of a run of challengers that also took in the StarCraft professional Lim Yo-hwan and the poker player Kim Su-jo.", scope: [] },
    ],
  },
  ...
  'lee-sang-min--kim-yoo-hyun--prior-show-27': {
    ...
    descriptionParts: [
      { text: "Both were on the thirteen-player all-star cast of The Genius season 4, Grand Final (tvN, 2015), and so played the same season directly. ", scope: [] },
      { text: "Lee Sang-min came in as the representative of season 2, having been through Rules of the Game (게임의 법칙) and Rule Breaker (룰 브레이커); Kim Yoo-hyun came in for season 3, Black Garnet (블랙가넷). Grand Final is the only season on which their credits meet.", scope: ['genius-2'] },
    ],
  },
  ...
  'lee-sang-min--lee-tae-gyun--co-season-s1-30': {
    ...
    scope: ['bg1'],
    descriptionParts: [
      { text: "Lee Sang-min spent Bloody Game season 1 (MBC every1, 1 November 2021 – 24 January 2022) in the studio as head of the panel, the 'Brain Corps' (브레인 군단), commentating on the players alongside the comedian Jang Dong-min, the broadcaster Park Ji-yoon, the economics YouTuber Shuka World (슈카월드) and the singer Choi Yena. ", scope: [] },
      { text: "Lee Tae-gyun was a player in that same season, dropped down into the basement early and climbed back to take it. ", scope: ['bg1'] },
      { text: "They shared a season and nothing more: the roles were separate — studio panel against player — and there is no evidence of direct interaction while the game was running.", scope: [] },
    ],
  },
  ...
  'lee-sang-min--park-ji-min--co-season-s1-31': {
    ...
    descriptionParts: [
      { text: "In Bloody Game season 1, Lee Sang-min watched and commentated as head of the studio panel, the 'Brain Corps' (브레인 군단) — billed as the chief of a corps that lives and dies on instinct — while Park Ji-min, then an MBC announcer, was a player in the house. ", scope: [] },
      { text: "She is the one who turned 'I set this board up from the start, so just follow me' into one of the season's quoted lines. ", scope: ['bg1'] },
      { text: "With one of them in the studio and the other in the mansion, though, they shared a season without ever playing one. Park returned as a player for season 2 as well, and that season had no panel seats at all.", scope: [] },
    ],
  },
  ...
  'ha-seung-jin--park-ji-min--rivalry-s2-32': {
    ...
    descriptionParts: [
      { text: "In Bloody Game 2 (2023) Park Ji-min was the wild team's spy inside the mansion and Ha Seung-jin had been on the mansion team from the start, which set them directly against each other. Ha was the first person in the house to argue for voting along gender lines, on the grounds of the difference in head count between the men and the women, and when the vote came to decide who went to the Death Match (데스매치) he said her name. ", scope: ['bg2'] },
      { text: "Park had been under suspicion from the opening days because of the reputation season 1 had fixed to her, and the first call against her in that house came out of his mouth. ", scope: ['bg1', 'bg2'] },
      { text: "That said, Ha was not the leader of the mansion's men's alliance; Namu Wiki reads his season 2 as a supporting part.", scope: ['bg2'] },
    ],
  },
  ...
  'heo-seong-beom--kang-ji-hoo--prior-show-35': {
    ...
    descriptionParts: [
      { text: "These two have never been in the same room. What they share is the KAIST seat on Coupang Play's University War (대학전쟁), handed on two seasons apart. ", scope: [] },
      { text: "Heo Seong-beom led the KAIST team in season 1 in 2023; Kang Ji-hoo played the KAIST team in season 3 across 2025–26 and finished third with it. ", scope: ['university-war-3'] },
      { text: "They have never sat in the same season — the KAIST roster on University War 3 is Kang Ji-hoo, Kim Jae-han, Kim Ji-woo and Jeon Ji-min, Heo is not on it, no earlier contestant returned for that season, and it was hosted by Hwang In-sung. Count one more overlap and the route to the school matches too: Heo came through the Korea Science Academy into KAIST's School of Computing, Kang graduated early out of Gyeonggi Buk Science High School and entered KAIST's mathematical sciences department in 2022. They are the only two in this lineup who went from a science-gifted school to KAIST, and they were not even in the same department.", scope: [] },
    ],
  },
  ...
  'lee-jin-hyung--shin-seung-yong--prior-show-37': {
    ...
    scopes: { description: ['bg2'] },
    descriptionParts: [
      { text: "There is no record anywhere of these two meeting. There are two physicians in this lineup and even the university matches. Lee Jin-hyung came out of Seoul Science High School and entered Seoul National University's Liberal Studies programme with the 2014 intake, dropped out, posted a perfect score on the 2019 CSAT, re-entered as the 2019 intake of its medical school, and now practises dermatology in Cheongdam; Shin Seung-yong came out of Icheon High School, graduated from Seoul National University, and runs a clinic in Gangnam doing skin and hair work. Whether it was the same college is not established: his education reads 'Seoul National University, graduated' and stops there, and the two intakes are close to eight years apart. ", scope: [] },
      { text: "One of them has already won a season of this franchise and the other has never played it, and there is no record of the two meeting on a programme or in a hospital. ", scope: ['bg2'] },
      { text: "The line does not mean they know each other. It means the same qualification is walking into the same house twice.", scope: [] },
    ],
  },
  ...
  'lee-tae-gyun--kim-yoo-hyun--prior-show-43': {
    ...
    scopes: { description: ['bg1'] },
    descriptionParts: [
      { text: "These two have sat at the same board, and the board was never broadcast. Both are on the cast list of Project Genius (프로젝트 지니어스), a brain-survival series shot by the YouTube channel TwoAces (투에이스) around May 2022. The eight names are Hong Jin-ho, Lee Doo-hee, Choi Yeon-seung, Kim Yoo-hyun, Kong Hyuk-joon, Jang Ji-soo, Hyun Seong-joo and Lee Tae-gyun — a casting that put the Genius line and the Bloody Game line at one table, since Choi Yeon-seung played season 1 alongside Lee Tae-gyun, and Hong Jin-ho and Hyun Seong-joo are on the list too. The production company suspended operations in 2024, the programme was never released, and nothing about what happened on that set survives anywhere. ", scope: [] },
      { text: "What this line records is not a result but a summons: the franchise's first champion and a professional gambler out of The Genius were called into the same room on the same day, four years ago.", scope: ['bg1'] },
    ],
  },
  ...
  'hong-jin-ho--lee-tae-gyun--prior-show-45': {
    ...
    scope: ['bg1'],
    descriptionParts: [
      { text: "The franchise's first winner and the most-connected person in this house were called into the same room four years ago. ", scope: ['bg1'] },
      { text: "Both are among the eight names on the cast list of Project Genius (프로젝트 지니어스), a brain-survival series shot around May 2022. The production company suspended operations in 2024 and the programme was never released, so there is no record of what passed between these two that day. What survives is the summons.", scope: [] },
    ],
  },
  ...
  'hyun-seong-joo--lee-tae-gyun--prior-show-46': {
    ...
    scope: ['bg1'],
    descriptionParts: [
      { text: "The season 1 winner and a professional poker player sit side by side on the eight-name cast list of Project Genius (프로젝트 지니어스), shot in 2022. ", scope: ['bg1'] },
      { text: "It was filmed and never broadcast. Nothing is confirmed beyond the two of them being called to the same table on the same day.", scope: [] },
    ],
  },
  ...
  'park-ji-min--choi-hye-sun--co-season-s3-42': {
    ...
    scope: ['bg3'],
    scopes: { description: ['bg1', 'bg2', 'bg3'] },
    descriptionParts: [
      { text: "Choi Hye-sun won her day-one Death Match (데스매치) in Bloody Game 3 by 58 chips to 12 and the rules sent her down to the ruins (잔해) anyway — and the butler running the phantom casino and the purgatory down there was Park Ji-min. ", scope: ['bg3'] },
      { text: "The woman who played seasons 1 and 2 and came out of them nicknamed the icon of betrayal (배신의 아이콘) was now turning other people's games for them, and Choi Hye-sun was one of the players who passed her table. ", scope: ['bg1', 'bg2', 'bg3'] },
      { text: "Same season, different seats; nothing individual between them is on record.", scope: ['bg3'] },
    ],
  },
