...
export const records: Record<string, SeasonRun[]> = {
  ...
  'park-ji-min': [
    ...
    },
    {
      season: 3,
      role: 'host',
      placement: '진행 · 딜러 겸 집사',
      sources: [P_PJM, S3_CAST],
      arc: '두 시즌을 플레이어로 뛴 뒤 시즌3에서는 잔해에 설치된 유령 카지노의 딜러이자 집사로 자리를 옮겼다. 자기가 당해 본 게임을 이번에는 남에게 굴려 주는 위치였다. 그를 알아본 재출연 참가자들이 시즌1 시절 별명인 ‘배신의 아이콘’이라 부르는 장면이 그대로 방송에 나온다.',
      beats: [
        '잔해 유령 카지노의 딜러 겸 집사',
        '참가자들이 그를 ‘배신의 아이콘’이라 부르는 장면이 방송을 탐',
